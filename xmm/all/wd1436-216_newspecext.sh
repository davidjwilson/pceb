...
evselect table=m1_S002_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS1source_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(26550.35,27866.58,600))'

evselect table=m2_S003_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS2source_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(26550.35,27866.58,600))'

evselect table=pn_S001_ImagingEvts_events_gtifiltered.fit withspectrumset=yes  spectrumset=EPNsource_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=20479 expression='(FLAG==0) && (PATTERN<=4) && ((X,Y) IN circle(26550.35,27866.58,600))'
#acceptchanrange=yes
#background

evselect table=m1_S002_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS1background_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(26672.1,27814.1,13200))'

evselect table=m2_S003_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS2background_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(26672.1,27814.1,13200))'

evselect table=pn_S001_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EPNbackground_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=20479 expression='(FLAG==0) && (PATTERN<=4) && ((X,Y) IN circle(26672.1,27814.1,13200))'
