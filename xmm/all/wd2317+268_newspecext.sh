...
evselect table=m1_S002_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS1source_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(27566.016,27076.367,600))'

evselect table=m2_S003_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS2source_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(27566.016,27076.367,600))'

evselect table=pn_S001_ImagingEvts_events_gtifiltered.fit withspectrumset=yes  spectrumset=EPNsource_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=20479 expression='(FLAG==0) && (PATTERN<=4) && ((X,Y) IN circle(27566.016,27076.367,600))'
#acceptchanrange=yes
#background

evselect table=m1_S002_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS1background_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(28666.2,24997.7,1172.67))'

evselect table=m2_S003_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EMOS2background_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=11999 expression='#XMMEA_EM && (PATTERN<=12) && ((X,Y) IN circle(28666.2,24997.7,1172.67))'

evselect table=pn_S001_ImagingEvts_events_gtifiltered.fit withspectrumset=yes spectrumset=EPNbackground_spectrum.fits energycolumn=PI spectralbinsize=5 withspecranges=yes specchannelmin=0 specchannelmax=20479 expression='(FLAG==0) && (PATTERN<=4) && ((X,Y) IN circle(28666.2,24997.7,1172.67))'
